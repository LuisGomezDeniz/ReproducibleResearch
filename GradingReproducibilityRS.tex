...
\begin{abstract}
Remote Sensing is a truly active research area, where many actors play a fundamental role, from industry (public or private) to large or small research groups. From that intensive activity, methods, algorithms and techniques are continuously published or broadcasted through papers, conferences, repositories or other means. In most cases, there is a sound interest from researchers to use those methods, what implies easy availability of the related methods (computational codes or more detailed descriptions) and implicitly, that method have been extensively tested and they are ready for its use. Reproducibility research comprises all those issues just mentioned. In this paper, we aim to provide insights to complement the visibility of research in the area of Remote Sensing and, what is considered more relevant: to \textit{seduce} Authors to include those resources  in their common scientific activity.
...
This paper is organized as follows. Section~\ref{Section: Reproducibility, Samples and Simulation} deals with data and simulation, paying special attention to Monte Carlo experiments. In Section~\ref{Section: How to Start Writing a Reproducible Article} we provide some clues for preparing a paper to satisfy the minimums to be considered reproducible. Section~\ref{Section: Good Scientific Practices} summarizes what is universally known as good scientific practices. Finally, Section~\ref{Section: Recommendations} collects a set of recommendations.

\section{Reproducibility, Samples and Simulation}
\label{Section: Reproducibility, Samples and Simulation}
...
\label{Section: How to Start Writing a Reproducible Article}
...
\label{Section: Good Scientific Practices}
